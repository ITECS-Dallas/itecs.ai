...
import { generateServiceSchema, generateFAQSchema, generateHowToSchema } from "@/lib/seo";
    ...
    <>
      ...
      <section className="py-12 mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link href="/data-audit" className="text-brand-accent hover:text-brand-accent-bright transition-colors text-sm">AI Data Audit &rarr;</Link>
      ...
      <FAQ items={service.faq} heading="AI Knowledge Base FAQ" />
      <CTASection />
