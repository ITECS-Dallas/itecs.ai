    ...
    <>
      ...
      <section className="py-12 mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link href="/insights/secure-business-data-chatgpt" className="text-brand-accent hover:text-brand-accent-bright transition-colors text-sm">Guide: Secure Your Data from ChatGPT &rarr;</Link>
        </div>
      </section>
