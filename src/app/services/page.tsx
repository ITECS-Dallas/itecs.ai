...
export const metadata = generatePageMetadata({
  ...
  description:
    "8 managed AI services for Dallas businesses with 10–300 employees: consulting, automation, custom ChatGPT, training, AI receptionist, CRM, and more. 22+ years IT experience.",
  path: "/services",
  keywords: [
...
const SERVICES_FAQ = [
  {
    ...
    answer:
      "Start with an AI consulting assessment. We audit your team's workflows, identify the biggest time drains, and recommend the service that delivers the fastest ROI — typically automation or a custom ChatGPT agent.",
  },
  {
    question: "Do I need to buy all 8 services at once?",
    answer:
  ...
  },
  {
    ...
    answer:
      "Yes. Every ITECS AI deployment runs in a private environment — your data never trains public models. We use AES-256 encryption, credential isolation, and comply with HIPAA, SOC 2, and PCI-DSS standards, backed by 22 years of cybersecurity operations.",
  },
  {
    question:
...
export default function ServicesPage() {
  return (
    <>
      ...
      {/* 3. SMB Pain Point — AI choice paralysis */}
      <PainPoint
        stat="73%"
        ...
        scenario={{
          ...
          result:
            "ITECS ran a 2-week AI readiness audit, identified tenant communication and lease processing as the highest-ROI automation targets, and deployed a custom ChatGPT agent integrated with Yardi plus an AI receptionist handling after-hours calls. The team now saves 32 hours per week and responds to tenant requests within 3 minutes instead of 4 hours.",
        }}
      />

      {/* 4. Three-phase AI journey diagram */}
      ...
      {/* 8. FAQ — LAST content section before CTA (V2.0 protocol) */}
