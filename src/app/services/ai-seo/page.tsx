...
const service = SERVICES.find((s) => s.slug === "ai-seo")!;
...
export default function AISEOPage() {
  return (
    <>
      ...
      <HowItWorks steps={service.howItWorks} heading="How AI SEO Works" />
      ...
      <section className="py-12 mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link href="/contact" className="text-brand-accent hover:text-brand-accent-bright transition-colors text-sm">Get Started &rarr;</Link>
        </div>
      </section>

      <FAQ items={service.faq} heading="AI SEO FAQ" />
      <CTASection />
