...
import { getAIPricingOffering } from "@/lib/constants";
...
const READINESS_ASSESSMENT = getAIPricingOffering("AI Readiness Assessment");
...
4. Distinguish the free /assessment intake form from the formal paid ${READINESS_ASSESSMENT.price} AI Readiness Assessment when relevant.
