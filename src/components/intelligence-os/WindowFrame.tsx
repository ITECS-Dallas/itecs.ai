  ...
  return (
    <AnimatePresence>
      {windowState.open && !windowState.minimized && (
        ...
        >
          <header
            className="flex h-10 shrink-0 touch-none select-none items-center justify-between gap-3 border-b border-[#7fb4d8]/20 bg-[#0a2134] pl-3"
          ...
          >
            ...
            <div className="flex h-full shrink-0 items-stretch" onPointerDown={(event) => event.stopPropagation()}>
              <button
                ...
                className="flex min-w-10 items-center justify-center text-slate-500 hover:bg-[#163b55] hover:text-white focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#5ba8d8]"
              ...
              <button
                ...
                className="flex min-w-10 items-center justify-center text-slate-500 hover:bg-red-500/20 hover:text-red-200 focus-visible:z-10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-red-300"
