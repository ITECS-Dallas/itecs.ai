        ...
        <li key={logo.name}>
          {logo.href ? (
            <Link
              ...
              className="group chamfer-md flex min-h-[86px] items-center justify-center border border-[var(--card-line)] bg-card px-5 py-4 transition-[border-color] duration-[var(--dur-base)] ease-[var(--ease-out)] hover:border-itecs-steel focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-ring)] focus-visible:ring-offset-2 focus-visible:ring-offset-bg-base"
            >
              <Image
                src={logo.src}
                alt={`${logo.name} logo`}
