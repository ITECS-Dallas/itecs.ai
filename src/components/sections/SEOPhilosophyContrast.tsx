        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <ScrollReveal delay={0.1}>
            <div className="h-full rounded-xl border border-rose-500/20 bg-rose-500/[0.03] p-6">
              <p className="text-xs font-medium tracking-[0.08em] uppercase text-rose-300 mb-5">
                What We Refuse
              </p>
          ...
          <ScrollReveal delay={0.2}>
            <div className="h-full rounded-xl border border-brand-accent/30 bg-brand-accent/[0.04] p-6">
              <p className="text-xs font-medium tracking-[0.08em] uppercase text-brand-accent mb-5">
                What We Do Instead
              </p>
              <ul className="space-y-4">
